...
public class Camera2BasicFragment extends Fragment
    ...
    private static final int GALLERY_REQUEST = 20000;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK){
            if (requestCode == GALLERY_REQUEST){
                ...
                Log.d("Objectdetection", imgFile.toString());
                Intent intent = null;
                intent = new Intent(getActivity(), ObjectDetectActivity.class);
                if (intent != null) {
                    Bundle bundle = new Bundle();
                    bundle.putString(Camera2BasicFragment.KEY_IMGPATH, imgFile.toString());
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
            }
